...
class UniversalScraper:
    ...
    def _submit_operation(
        self, method_name: str, *args, timeout: int = None, **kwargs
    ) -> Any:
    ...
    def find_elements(
        self, selector: str, by: str = "css", timeout: int = None
    ) -> List[Any]:
        """
    ...
    def click(
        self, selector: str, by: str = "css", wait: bool = True, timeout: int = None
    ) -> bool:
        """
    ...
    def _internal_click(
        self, selector: str, by: str = "css", wait: bool = True
    ) -> bool:
        """
    ...
    def type_text(
        self, selector: str, text: str, by: str = "css", clear: bool = True
    ) -> bool:
        """
    ...
    def wait_for_captcha(
        self, timeout: int = 60, auto_solve: bool = True
    ) -> Dict[str, Any]:
        """
    ...
    def download_all_images(
        self, selector: str = "img", attribute: str = "src"
    ) -> List[str]:
        """
